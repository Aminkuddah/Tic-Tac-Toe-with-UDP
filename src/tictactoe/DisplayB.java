...
public class DisplayB extends javax.swing.JFrame {

    static InetAddress ia;
    static int Port;
    static int nilai, nilaiX, nilaiO, pemainAcak, pionAcak;
    static String pionA, pionB, s, s2;
    static boolean playerA, playerB, isIsi;
    static int position;
    ...
    private void initComponents() {
        ...
        btnAcak.setBounds(850, 120, 160, 40);
        ...
        btnReset.setBounds(660, 120, 160, 40);
        ...
        textPlayer.setPreferredSize(new java.awt.Dimension(1180, 800));
        getContentPane().add(textPlayer);
        textPlayer.setBounds(660, 170, 350, 50);

        gambar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hore.gif"))); // NOI18N
        getContentPane().add(gambar);
        gambar.setBounds(590, 230, 470, 240);
    ...
    static void terima(String pesan) {
        switch (pesan) {
            ...
            case "pemain0":
                playerA = false;
                textPlayer.setText("Giliran Dia!");
                setDisabled();
                break;
            case "pemain1":
                playerA = true;
                textPlayer.setText("Giliran Kamu!");
                setEnabled();
                break;
            case "pionan0":
                pionA = "O";
    ...
    static void pemenang() {
        if (btn1.getText() == "O" && btn2.getText() == "O" && btn3.getText() == "O") {
            if (playerA) {
                textPlayer.setText("Pemenangnya Dia! ");
            } else {
                textPlayer.setText("Pemenangnya Kamu!");
            }
            setDisabled();
        ...
        if (btn1.getText() == "X" && btn2.getText() == "X" && btn3.getText() == "X") {
            ...
            setDisabled();
            gambar.setVisible(true);
        } else if(btn1.getText() != "" && btn2.getText() != "" && btn3.getText() != "" && btn4.getText() != "" && btn5.getText() != "" &&
                btn6.getText() != "" && btn7.getText() != "" && btn8.getText() != "" && btn9.getText() != ""){
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DisplayB.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
    ...
    private void btnAcakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcakActionPerformed
        ...
        try {
            s = "pemain" + Integer.toString(pemainAcak);
            byte[] b = s.getBytes();
            DatagramPacket dp = new DatagramPacket(b, b.length, ia, Port);
            DatagramSocket sender;
            sender = new DatagramSocket();
        ...
        s2 = "pionan" + Integer.toString(pionAcak);
        byte[] b2 = s2.getBytes();
        try {
            DatagramPacket dp2 = new DatagramPacket(b2, b2.length, ia, Port);
            DatagramSocket sender2;
            sender2 = new DatagramSocket();
            sender2.send(dp2);
        } catch (IOException ex) {
            Logger.getLogger(DisplayB.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayB().setVisible(true);
            }
        });

        try {
            ia = InetAddress.getByName("192.168.65.106");
            Port = 2134;
            ...
            while (!s.trim().equals("exit")) {
                ...
                s = new String(data, 0, incoming.getLength()).trim();
    ...
    private static javax.swing.JLabel gambar;
