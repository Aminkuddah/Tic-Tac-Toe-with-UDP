...
public class DisplayD extends javax.swing.JFrame {
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DisplayD.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnAcakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcakActionPerformed
        ...
        s2 = "pion" + Integer.toString(pionAcak);
        byte[] b2 = s2.getBytes();
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
