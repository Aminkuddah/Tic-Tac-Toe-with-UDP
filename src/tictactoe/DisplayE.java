...
public class DisplayE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gambar.setBounds(580, 230, 480, 220);
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DisplayE.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnAcakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcakActionPerformed
        ...
        byte[] b2 = s2.getBytes();
        try {
            DatagramPacket dp = new DatagramPacket(b2, b2.length, ia, Port);
            DatagramSocket sender;
            sender = new DatagramSocket();
            sender.send(dp);
        } catch (IOException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
